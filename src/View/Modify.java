...
public class Modify {
    ...
    public Modify(User user, Database database) {
        ...
        panel.add(new JLabel("Modify", 40, GUIConstants.blue, Font.BOLD), BorderLayout.NORTH);
        ...
        submit.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (lastName.isEmpty()) {
                    new Alert("Last name cannot empty", frame);
                    return;
                }
                if (email.isEmpty()) {
                    new Alert("Email cannot empty", frame);
                    return;
                }
        ...
        JLabel changePassword = new JLabel("Change Passwod", 20, GUIConstants.black, Font.BOLD);
